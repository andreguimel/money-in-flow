...
import { applySecureWebSocketConfig, SecureWebSocket } from "@/utils/websocket-fix";
...
const createSupabaseClient = (): SupabaseClient => {
  ...
  // Aplicar configuração segura de WebSocket ANTES de criar o cliente
  if (typeof window !== 'undefined') {
  ...
  console.log('🔒 Configuração Supabase WebSocket:', {
  ...
  const config = {
    ...
    realtime: {
      ...
      // Usar WebSocket seguro que força WSS em HTTPS
      transport: isHTTPS ? SecureWebSocket as any : undefined,
